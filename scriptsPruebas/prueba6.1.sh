...
if [ -f "$MEM_CONFIG" ]; then
  ...
  sed -i "s/^TAM_PAGINA=.*/TAM_PAGINA=32/" "$MEM_CONFIG"
  sed -i "s/^ENTRADAS_POR_TABLA=.*/ENTRADAS_POR_TABLA=8/" "$MEM_CONFIG"
  sed -i "s/^CANTIDAD_NIVELES=.*/CANTIDAD_NIVELES=3/" "$MEM_CONFIG"
  sed -i "s/^RETARDO_MEMORIA=.*/RETARDO_MEMORIA=100/" "$MEM_CONFIG"
  sed -i "s#^PATH_SWAPFILE=.*#PATH_SWAPFILE=/home/utnso/swapfile.bin#" "$MEM_CONFIG"
  sed -i "s/^RETARDO_SWAP=.*/RETARDO_SWAP=2500/" "$MEM_CONFIG"
...
if [ -f "$KERNEL_CONFIG" ]; then
  ...
  sed -i "s/^ALGORITMO_CORTO_PLAZO=.*/ALGORITMO_CORTO_PLAZO=SRT/" "$KERNEL_CONFIG"
  sed -i "s/^ALGORITMO_INGRESO_A_READY=.*/ALGORITMO_INGRESO_A_READY=PMCP/" "$KERNEL_CONFIG"
  sed -i "s/^ALFA=.*/ALFA=0.75/" "$KERNEL_CONFIG"
  sed -i "s/^ESTIMACION_INICIAL=.*/ESTIMACION_INICIAL=100/" "$KERNEL_CONFIG"
...
if [ -f "$CPU_CONFIG" ]; then
  ...
  sed -i "s/^ENTRADAS_CACHE=.*/ENTRADAS_CACHE=2/" "$CPU_CONFIG"
  sed -i "s/^REEMPLAZO_CACHE=.*/REEMPLAZO_CACHE=CLOCK-M/" "$CPU_CONFIG"
  sed -i "s/^RETARDO_CACHE=.*/RETARDO_CACHE=50/" "$CPU_CONFIG"
  sed -i "s/^LOG_LEVEL=.*/LOG_LEVEL=INFO/" "$CPU_CONFIG"
else
  echo "❌ No se encontró $CPU_CONFIG"
...
# ==== CPU(3) ====
CPU_CONFIG="$BASE_DIR/cpu/cpu3.config"
if [ -f "$CPU_CONFIG" ]; then
  sed -i "s/^IP_MEMORIA=.*/IP_MEMORIA=$IP_MEMORIA/" "$CPU_CONFIG"
  sed -i "s/^PUERTO_MEMORIA=.*/PUERTO_MEMORIA=$PUERTO_MEMORIA/" "$CPU_CONFIG"
  sed -i "s/^IP_KERNEL=.*/IP_KERNEL=$IP_KERNEL/" "$CPU_CONFIG"
  sed -i "s/^PUERTO_KERNEL_DISPATCH=.*/PUERTO_KERNEL_DISPATCH=$PUERTO_DISPATCH/" "$CPU_CONFIG"
  sed -i "s/^PUERTO_KERNEL_INTERRUPT=.*/PUERTO_KERNEL_INTERRUPT=$PUERTO_INTERRUPT/" "$CPU_CONFIG"
  sed -i "s/^ENTRADAS_TLB=.*/ENTRADAS_TLB=256/" "$CPU_CONFIG"
  sed -i "s/^REEMPLAZO_TLB=.*/REEMPLAZO_TLB=FIFO/" "$CPU_CONFIG"
  sed -i "s/^ENTRADAS_CACHE=.*/ENTRADAS_CACHE=256/" "$CPU_CONFIG"
  sed -i "s/^REEMPLAZO_CACHE=.*/REEMPLAZO_CACHE=CLOCK/" "$CPU_CONFIG"
  sed -i "s/^RETARDO_CACHE=.*/RETARDO_CACHE=1/" "$CPU_CONFIG"
  sed -i "s/^LOG_LEVEL=.*/LOG_LEVEL=INFO/" "$CPU_CONFIG"
else
  echo "❌ No se encontró $CPU_CONFIG"
fi
...
# ==== CPU(4) ====
CPU_CONFIG="$BASE_DIR/cpu/cpu4.config"
if [ -f "$CPU_CONFIG" ]; then
  sed -i "s/^IP_MEMORIA=.*/IP_MEMORIA=$IP_MEMORIA/" "$CPU_CONFIG"
  sed -i "s/^PUERTO_MEMORIA=.*/PUERTO_MEMORIA=$PUERTO_MEMORIA/" "$CPU_CONFIG"
  sed -i "s/^IP_KERNEL=.*/IP_KERNEL=$IP_KERNEL/" "$CPU_CONFIG"
  sed -i "s/^PUERTO_KERNEL_DISPATCH=.*/PUERTO_KERNEL_DISPATCH=$PUERTO_DISPATCH/" "$CPU_CONFIG"
  sed -i "s/^PUERTO_KERNEL_INTERRUPT=.*/PUERTO_KERNEL_INTERRUPT=$PUERTO_INTERRUPT/" "$CPU_CONFIG"
  sed -i "s/^ENTRADAS_TLB=.*/ENTRADAS_TLB=0/" "$CPU_CONFIG"
  sed -i "s/^REEMPLAZO_TLB=.*/REEMPLAZO_TLB=FIFO/" "$CPU_CONFIG"
  sed -i "s/^ENTRADAS_CACHE=.*/ENTRADAS_CACHE=0/" "$CPU_CONFIG"
  sed -i "s/^REEMPLAZO_CACHE=.*/REEMPLAZO_CACHE=CLOCK/" "$CPU_CONFIG"
  sed -i "s/^RETARDO_CACHE=.*/RETARDO_CACHE=0/" "$CPU_CONFIG"
  sed -i "s/^LOG_LEVEL=.*/LOG_LEVEL=INFO/" "$CPU_CONFIG"
else
  echo "❌ No se encontró $CPU_CONFIG"
fi
